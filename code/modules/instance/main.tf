...
locals {
  ...
  private_instances = {
    "web1" = {
      ...
      instance_name  = "web1"
      file_source    = "C:/Users/moham/OneDrive/Desktop/Terraform Final Project/wp1/index.html"
    }
    "web2" = {
      subnet_id      = var.priv_sub2_id
      instance_name  = "web2"
      file_source    = "C:/Users/moham/OneDrive/Desktop/Terraform Final Project/wp2/index.html"
    }
  }
}
...
resource "aws_instance" "nginx" {
  ...
  provisioner "local-exec" {
    command = "echo ${each.value.instance_name} Public IP ${self.public_ip} >> IPs.txt"
  }
  ...
  connection {
    type        = "ssh"
    user        = "ec2-user"
    private_key = file("C:/Users/moham/Downloads/mohamedfayezkeypair.pem")
    host        = self.public_ip
  }
...
resource "aws_instance" "web" {
  ...
  provisioner "local-exec" {
    command = "echo ${each.value.instance_name} Private IP ${self.private_ip} >> IPs.txt"
  }
  ...
  provisioner "file" {
    ...
    connection {
      ...
      bastion_private_key = file("C:/Users/moham/Downloads/mohamedfayezkeypair.pem")
    }
  }
